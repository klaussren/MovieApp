...
class MovieSearchPagingAdapter: PagingDataAdapter<Movie, MovieSearchPagingAdapter.MyViewHolder>(DIFF_UTIL) {
    ...
    override fun onBindViewHolder(holder: MovieSearchPagingAdapter.MyViewHolder, position: Int) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MovieSearchPagingAdapter.MyViewHolder {
